...
(function (n, t, a, e, co) {
  ...
  "AP-VMEVYG8PSBR8-2",
  {
    //engagementChecksumFileUrl:"Engagement_checksum_sreevani webapp_Production (18).json",
...
function storeValues() {
  aptrinsic("track", "amount", {
    amountentered: document.getElementById("amount").value,
  });
  aptrinsic("track", "interest", {
    interestentered: document.getElementById("interest").value,
  });
}
function trackData() {
  aptrinsic("track", "GSCE2", {
    name: "sree",
